...
function Assignmenthomepge() {
    ...
    useEffect(() => {
        extractdata();
    }, [Classdatas, ClassRoom, tid, TeachAssignment]);
                ...
                {subj.map((value) => {
                    return <div>
                        ...
                        <div className="asglistitem">
                            <Asignitems datas={TeachAssignment} tid={tid} clsid={value.classid} subject={value.subject}/>
                        </div>
                    </div>
                })}
...
export default Assignmenthomepge;